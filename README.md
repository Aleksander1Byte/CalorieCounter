...
Calorie Counter - сервис для измерения КБЖУ и микронутриентов блюд по текстовому описанию, изображению или голосовому сообщению

## Пример работы

<p align="center">
  <img src="docs/demo.gif" alt="Демо работы бота" width="420">
</p>

Больше примеров можно посмотреть в Wiki.
...
- Приём текстов, изображений и голосовых сообщений до 2 минут
- Локальная расшифровка voice message через faster-whisper без внешних speech-to-text API
...
| [Текст, изображение или голосовое до 2 минут]  | Получить анализ КБЖУ и микронутриентов |
